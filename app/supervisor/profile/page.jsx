            ...
            <main className="max-w-4xl mx-auto px-4 pt-32 pb-12">
                <div className="premium-glass p-8 rounded-[3rem] shadow-2xl border border-white/20 dark:border-slate-800/50">
                    <div className="flex items-center gap-4 mb-10 pb-6 border-b border-slate-100 dark:border-slate-800">
                        ...
                        <div>
                            <h1 className="text-3xl font-black text-slate-800 dark:text-white">إعدادات المشرف</h1>
                            <p className="text-slate-500 dark:text-slate-400 font-bold uppercase tracking-widest text-xs mt-1">تعديل البيانات الشخصية وكلمة المرور للمشرف</p>
                        </div>
                    </div>
                    ...
                    <form onSubmit={handleUpdateProfile} className="space-y-8">
                        ...
                        <div className="flex gap-4 pt-4">
                            <button
                                type="submit"
                                disabled={saving}
                                className="flex-1 px-8 py-4 bg-indigo-600 hover:bg-indigo-700 text-white rounded-2xl font-black shadow-lg shadow-indigo-200 dark:shadow-none transition-all disabled:opacity-50 active:scale-95"
                            >
