                                                ...
                                                <div className="flex justify-between items-start mb-4">
                                                    <div className="flex items-center gap-2">
                                                        ...
                                                        <button 
                                                            ...
                                                            className="text-slate-300 hover:text-blue-500 hover:bg-blue-50 p-1.5 rounded-lg transition-colors group-hover:opacity-100 opacity-50"
                                                            title="تعديل الجلسة"
                                                        >
                                                        ...
                                                        <button 
                                                            ...
                                                            className="text-slate-300 hover:text-red-500 hover:bg-red-50 p-1.5 rounded-lg transition-colors group-hover:opacity-100 opacity-50"
                                                            title="حذف الجلسة"
                                                        >
